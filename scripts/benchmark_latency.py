...
def run_benchmark(args) -> dict[str, Any]:
    ...
    for mode in ("baseline", "probe", "probe_classifier"):
        ...
        aggregate[mode] = {
            ...
            "blocked_total": sum(1 for result in mode_results if result["status"] == "blocked"),
        }
    ...
    return {
        ...
        "guard_config": {
            ...
            "classifier_allow_threshold": args.classifier_allow_threshold,
            "classifier_block_threshold": args.classifier_block_threshold,
            "final_classifier_check": args.final_classifier_check,
        },
